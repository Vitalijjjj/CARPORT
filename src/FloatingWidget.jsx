  ...
  async function handleSubmit(e) {
    ...
    try {
      await fetch('/api/leads.php', {
        ...
        body: JSON.stringify({ name, phone, source: 'widget' }),
      })
          ...
          {sent ? (
            ...
            <>
              ...
              <div className="fw-alts">
                <a href="https://wa.me/351928363003" className="fw-alt fw-wa" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/turboeagle.pt?igsh=MWVscmNnNXo5cWUyeQ%3D%3D&utm_source=qr" className="fw-alt fw-ig" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                ...
                <a href="https://www.facebook.com/people/Linhas-Janotas/61570105314857/?mibextid=wwXIfr&rdid=ktOqGF2zeauFpdHm&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1D3kQ3XXpu%2F%3Fmibextid%3DwwXIfr%26ref%3D1" className="fw-alt fw-fb" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
