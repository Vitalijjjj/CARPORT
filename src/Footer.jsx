        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-brand-desc">
              TURBOEAGLE — Comércio de Automóveis. Helping clients in Portugal buy selected
              electric and hybrid BMW and Mercedes-Benz vehicles — from stock or imported from Germany.
            </p>
          ...
          <div className="footer-info">
            <div className="footer-row">
              <div className="footer-col">
                ...
                <Link to="/#import">Import from Germany</Link>
                <Link to="/#quiz">Financing</Link>
              ...
              <div className="footer-col">
                ...
                <Link to="/#models">Available Cars</Link>
                <Link to="/#import">Custom Import</Link>
                <Link to="/#financing">Financing</Link>
                <Link to="/#quiz">Trade-In</Link>
                <Link to="/#models">Warranty Support</Link>
                <Link to="/#location">Portugal Delivery</Link>
              </div>
              <div className="footer-col">
