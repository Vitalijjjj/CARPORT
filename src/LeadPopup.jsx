    ...
    <div className="lp-backdrop" onClick={close}>
      <div className="lp-sheet" onClick={e => e.stopPropagation()}>
        ...
        {sent ? (
          ...
          <>
            <span className="lp-eyebrow">{t.leadPopup.eyebrow}</span>
            <h3 className="lp-heading">{t.leadPopup.title}</h3>
            <p className="lp-sub">{t.leadPopup.sub}</p>
            <form onSubmit={handleSubmit} noValidate>
              ...
              <p className="lp-disclaimer">{t.leadPopup.disclaimer}</p>
            </form>
            <div className="lp-alts">
              <a href="https://wa.me/351928363003" target="_blank" rel="noopener noreferrer" className="lp-alt lp-wa">
              ...
              <a href="https://www.instagram.com/turboeagle.lda?igsh=MTRxd3l0bjNudDF4Yg%3D%3D" target="_blank" rel="noopener noreferrer" className="lp-alt lp-ig">
              ...
              <a href="https://www.facebook.com/share/1D3kQ3XXpu/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="lp-alt lp-fb">
