...
export default function Modal({ onClose, carName }) {
  const { t } = useLang()
      ...
      <div className="modal-box" onClick={e => e.stopPropagation()}>
        ...
        {sent ? (
          <div className="modal-sent">
            ...
            <h3>{t.modal.sent}</h3>
            <p>{t.modal.sentSub}</p>
            <button className="btn btn-primary" style={{ margin: '0 auto' }} onClick={onClose}>Close</button>
          </div>
        ) : (
          <>
            ...
            <div className="modal-alts">
              <span className="modal-alts-label">{t.modal.orVia}</span>
              <div className="modal-alts-btns">
                <a href="https://wa.me/351928363003" target="_blank" rel="noopener noreferrer" className="modal-alt modal-wa">
                ...
                <a href="https://www.instagram.com/turboeagle.lda?igsh=MTRxd3l0bjNudDF4Yg%3D%3D" target="_blank" rel="noopener noreferrer" className="modal-alt modal-ig">
                ...
                <a href="https://www.facebook.com/share/1D3kQ3XXpu/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="modal-alt modal-fb">
